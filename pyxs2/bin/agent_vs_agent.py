...
$ python -m pyxs2.bin.agent_vs_agent --server --map AbyssalReef --agent tstarbot.agents.zerg_agent.ZergAgent --agent_race zerg

And on the machine the client(agent2) plays on:
$ python -m pyxs2.bin.agent_vs_agent --noserver --agent tstarbot.agents.zerg_agent.ZergAgent --agent_race zerg
"""
...
from pyxs2.env import lan_sc2_env
#from pyxs2.env import run_loop
from pyxs2.env import sc2_env, lan_server_sc2_env
from pyxs2.lib import point_flag
...
flags.DEFINE_string("agent", "pyxs2.agents.random_agent.RandomAgent",
